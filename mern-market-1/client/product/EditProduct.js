      ...
      <Card className={classes.card} elevation={24}>
        ...
        <CardContent>
          ...
          <TextField
            ...
            margin="normal"
          /><br/>
          <TextField id="category" label="Categoria" className={classes.textField} value={values.category} onChange={handleChange('category')} margin="normal"/><br/>
          <TextField id="quantity" label="Cantidad" className={classes.textField} value={values.quantity} onChange={handleChange('quantity')} type="number" margin="normal"/><br/>
          <TextField id="price" label="Precio" className={classes.textField} value={values.price} onChange={handleChange('price')} type="number" margin="normal"/><br/>
          {
        ...
        <CardActions>
          <Button color="primary" variant="contained" onClick={clickSubmit} className={classes.submit}>Modificar</Button>
          <Link to={'/seller/shops/edit/'+match.params.shopId} className={classes.submit}><Button variant="contained">Cancelar</Button></Link>
        </CardActions>
      </Card>
    </div>)
}
